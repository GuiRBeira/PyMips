...
def processar_codigo(codigo, registradores_widget, console_widget, traducao_widget, memoria_widget):
    token_patterns = [
    (r'[a-zA-Z]\w*:', 'LABEL'),
    ...
    validar_codigo(tokens, registradores_widget, console_widget,traducao_widget, memoria_widget)