...
def executa_linha_linha(linhas_do_codigo, registradores_widget, console_widget, traducao_widget, memoria_widget):
    ...
    while linha_atual_index is not None and linha_atual_index < len(linhas_do_codigo):
        ...
        if referencia[1] == 'LABEL':
            ...
            if len(linha_sem_espacos) > 1 and linha_sem_espacos[1][1] == 'ASCIIZ':
            ...
            registradores_widget.endereco_label[nome_label] = {'valor': valor, 'linha': linha}
        ...
        elif referencia[1] == 'INSTRUCTION' and main_encontrada:
