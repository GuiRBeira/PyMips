...
def validar_codigo(tokens, registradores_widget, console_widget,traducao_widget, memoria_widget):
    ...
    executa_linha_linha(linhas_do_codigo, registradores_widget, console_widget, traducao_widget, memoria_widget)