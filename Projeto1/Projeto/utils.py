...
def run_codigo(texto, console_widget, registradores_widget, traducao_widget, memoria_widget):
    limpa_console(console_widget, registradores_widget, traducao_widget, memoria_widget)
    texto_inserido = texto.get("1.0", tk.END)
    processar_codigo(texto_inserido, registradores_widget, console_widget, traducao_widget, memoria_widget)
