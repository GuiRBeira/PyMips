...
run_button = tk.Button(toolbar_frame, text="Run", command=lambda: ut.run_codigo(texto, console_widget, registradores_widget, traducao_widget, memoria_widget, modo_debug=False), bg="#1e1e1e", fg="#27AE60")
...
debug_button = tk.Button(toolbar_frame, text="Debug", command=lambda: ut.run_codigo(texto, console_widget, registradores_widget, traducao_widget, memoria_widget, modo_debug=True), bg="#1e1e1e", fg="#27AE60")
